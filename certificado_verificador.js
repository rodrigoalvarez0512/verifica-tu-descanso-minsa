/*
 * ===============================================
 * SCRIPT PARA VERIFICADOR DE CERTIFICADOS (certificado.html)
 * ===============================================
 */
            ...
            <div class="result-card result-card--valid">
                <div class="result-card__header">
                    ...
                    <div>
                        ...
                        <p class="result-card__subtitle">La información del certificado ha sido verificada en el sistema.</p>
                    </div>
                </div>
                <div class="result-card__details">
                    <div class="detail-item"><span class="label">Paciente</span><span class="value">${data.paciente_nombre || 'N/A'}</span></div>
                    <div class="detail-item"><span class="label">Edad</span><span class="value">${data.paciente_edad || 'N/A'} años</span></div>
                    ...
                    <div class="detail-item"><span class="label">Fecha Revisión</span><span class="value">${formatDate(data.fecha_revision)}</span></div>
    ...
    async function handleSearch(event) {
        ...
        try {
            ...
            const { data, error } = await clienteSupabase
                .from('certificados_medicos') // <-- NUEVA TABLA
                .select()
